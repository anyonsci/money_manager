...
export const WorkspaceProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const updateActiveWorkspace = async (data: { name?: string; defaultCurrency?: string }): Promise<Workspace> => {
    ...
    const errStr = typeof res.error === 'string' ? res.error : res.error?.message; throw new Error(errStr || 'Failed to update workspace');
  };
  ...
  const createWorkspace = async (
    ...
    const errStr = typeof res.error === 'string' ? res.error : res.error?.message; throw new Error(errStr || 'Failed to create workspace');
  };
